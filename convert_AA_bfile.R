...
populations <- c("YRI", "CEU", "CHB", "BEB")

# Create the output directory
output_dir <- "/home/tx56/palmer_scratch/deepsweep_empirical/1kgp_AA_bfile"
...
for (pop in populations) {
  for (i in 1:22) {
    ...
    bim_file <- sprintf("/home/tx56/palmer_scratch/deepsweep_empirical/1kgp_bfile/%s.%d.bim", pop, i)
