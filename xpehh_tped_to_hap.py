...
def main():
    ...
    path = "/home/tx56/ycga_work/1kgp_joint"

    for pop in target_pops:
        for i in range(1, 23):
            input_file = f"{path}/{pop}.{i}.joint.tped"
            ...
            output_file_hap = f"/home/tx56/ycga_work/1kgp_joint/{pop}.{i}.joint.hap"
            output_file_map = f"/home/tx56/ycga_work/1kgp_joint/{pop}.{i}.joint.map"
